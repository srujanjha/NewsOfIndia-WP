...
{
    public class PvponlineViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "PvponlineDataSource"; }
        }
                ...
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            ...
                            NavigationServices.NavigateToPage("PvponlineDetail", item);
                        });
                }
        ...
        {
            return new PvponlineDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("PvponlineDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("PvponlineList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("PvponlineDetail");
        }
    }
}
